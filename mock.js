...
export const mockData = {
  ...
  hero: {
    ...
    description: "Liberte-se de PayJoy, Soundi, M-Kopa, Domo, ItelOS, Tranzact e outros bloqueios corporativos. Serviço remoto sem perda de dados.",
  ...
  supportedMdmSystems: [
    ...
    {
      name: "Soundi", 
      description: "Gerenciamento corporativo de dispositivos",
      icon: "Building"
    },
    {
      name: "M-Kopa",
      description: "Bloqueios por empréstimo de dispositivos",
      icon: "DollarSign"
    },
    {
      name: "Domo",
      description: "Gestão empresarial de dispositivos móveis",
      icon: "Shield"
    },
    {
      name: "ItelOS",
